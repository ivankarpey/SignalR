...
namespace Microsoft.AspNetCore.SignalR.Client.Internal
{
    internal static class SignalRClientLoggerExtensions
    {
        ...
        private static readonly Action<ILogger, Exception> _invokeAfterTermination =
            LoggerMessage.Define(LogLevel.Error, 19, "Invoke was called after the connection was terminated.");
        ...
        {
            _shutdownConnection(logger, exception);
        }
        ...
        public static void InvokeAfterTermination(this ILogger logger)
        {
            _invokeAfterTermination(logger, null);
        }
